...
from ..views.oj import (ContestAccessAPI, ContestAnnouncementListAPI,
                        ContestAPI, ContestListAPI, ContestPasswordVerifyAPI,
                        ContestRankAPI, ContestUserAPI)
...
urlpatterns = [
    ...
    url(r"^contestuser/?$", ContestUserAPI.as_view(), name="contest_user_api"),
]
